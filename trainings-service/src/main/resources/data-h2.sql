...
VALUES
    ...
    ('k9l8m7n6-o5p4-q3r2-s1t0-u9v8w7x6y5z4', 'TRN-11223344', 'Ice Mastery', 'Advanced cold-weather survival and ice-type mastery', 'INTERMEDIATE', 5, 'ACTIVE', 'SPECIAL', 189.99, 'Snowpoint Gym - Sinnoh'),
    ('l8m7n6o5-p4q3-r2s1-t0u9-v8w7x6y5z4a3', 'TRN-22334455', 'Dark Energy Control', 'Harnessing the power of darkness', 'ADVANCED', 7, 'ACTIVE', 'SPECIAL', 229.99, 'Virbank Complex - Unova'),
    ('m7n6o5p4-q3r2-s1t0-u9v8-w7x6y5z4a3b2', 'TRN-33445566', 'Ghost Communication', 'Learning to communicate with ghost-type creatures', 'ADVANCED', 6, 'ACTIVE', 'SPECIAL', 209.99, 'Old Chateau - Sinnoh'),
    ('n6o5p4q3-r2s1-t0u9-v8w7-x6y5z4a3b2c1', 'TRN-44556677', 'Water Acrobatics', 'Advanced water movement techniques', 'INTERMEDIATE', 4, 'ACTIVE', 'SPECIAL', 169.99, 'Humilau Gym - Unova'),
    ('o5p4q3r2-s1t0-u9v8-w7x6-y5z4a3b2c1d0', 'TRN-55667788', 'Grass Healing', 'Natural healing methods using grass-type energy', 'BEGINNER', 3, 'ACTIVE', 'SPECIAL', 129.99, 'Eterna Forest - Sinnoh'),

-- wait for service marked for deletion
    ('f6794db9-81f3-4e3d-91a7-004bacd45403', 'TRN-55667789', 'testing', 'energy test', 'BEGINNER', 3, 'ACTIVE', 'SPECIAL', 129.99, 'gridlock');
